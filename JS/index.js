...
refs.burgerBtn.addEventListener('click', () => refs.container.classList.remove('visually-hidden'));

refs.closeBtn.addEventListener('click', () => refs.container.classList.add('visually-hidden'));

refs.links.forEach(link =>
  link.addEventListener('click', () => refs.container.classList.add('visually-hidden'))
);
...
class MySlider {
  ...
  increment() {
    if (this.checkPrev())
      this.sliderItems[this.activeIdx - 1].classList.remove('slider__item--prev');
    this.sliderItems[this.activeIdx].classList.remove('slider__item--active');
    if (this.checkNext())
      this.sliderItems[this.activeIdx + 1].classList.remove('slider__item--next');
    ...
    if (this.checkNext()) this.sliderItems[this.activeIdx + 1].classList.add('slider__item--next');
  ...
  decrement() {
    ...
    if (this.checkPrev()) this.sliderItems[this.activeIdx - 1].classList.add('slider__item--prev');
    this.sliderItems[this.activeIdx].classList.add('slider__item--active');
    if (this.checkNext()) this.sliderItems[this.activeIdx + 1].classList.add('slider__item--next');
